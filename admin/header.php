...
<body>
	...
	<div class="col-md-2">
		...
		<ul class="nav nav-pills nav-stacked">
			...
			<li><a href="tagihan.php"><span class="glyphicon glyphicon-briefcase"></span>  Pembayaran</a></li>
			<li><a href="#"><span class="glyphicon glyphicon-briefcase"></span>  Laporan</a></li>
			<li><a href="ganti_pass.php"><span class="glyphicon glyphicon-lock"></span> Administrator</a></li>
